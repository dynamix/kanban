...
class Admin::HistoryEntriesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     HistoryEntry: create, read, update, destroy, custom_action
  #
  #   editor:
  #     HistoryEntry: create, read, update, custom_action_for_an_item
  #
