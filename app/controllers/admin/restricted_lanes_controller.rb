...
class Admin::RestrictedLanesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     RestrictedLane: create, read, update, destroy, custom_action
  #
  #   editor:
  #     RestrictedLane: create, read, update, custom_action_for_an_item
  #
