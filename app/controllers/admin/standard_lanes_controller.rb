...
class Admin::StandardLanesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     StandardLane: create, read, update, destroy, custom_action
  #
  #   editor:
  #     StandardLane: create, read, update, custom_action_for_an_item
  #
